<?php
    ...
    function dump()
    {
        ...
        // the <pre> tag used in dump is placed around debugging code
        require("../views/dump.php");
        exit;
    }
    
    // require() brings over code from the called file, this could either be
    // executable code, or needed functions
